...
[Примеры компонентов для сборок](/ru/shop/DIY) и [список оборудования и расходников](/ru/shop/nessesary).

**Обращаю внимание, что любой набор должен включать в себя в первую очередь симулятор.**

- [Примеры симуляторов](/ru/intro/sim)
...
> что такое "бинд" смотри [тут](/ru/community/glossarium)
...
Опыт показал, что от цетуса более-менее годный только шлем при цене 70$ за новый, дороже - и он не нужен.
Сам дрон, конечно, летать будет, но он несуразный - слишком большой и тяжелый для вупа. В таком размере и весе квад должен быть карбоновым с пропами на 2.5-3" и это будет совершенно другого уровня аппарат по живучести, полетной динамике и времени полета.
Аппаратура в комплекте тоже отвратительная, несмотря на елрс (если это не фрскай версия). В ней стоит прошивка, измененная самими бетафпв, что крайне плохо. Вы не увидите ни обновлений ни поддержки от сообщества, ни функционала нормальной аппаратуры с edgetx. Не говоря уже про посредственное качество стиков.
...
- Аккумуляторы: cnhl/gnb/tattu с рекомендуемыми характеристиками для выбранного дрона на тех же разъемах, рекомендуется для начала минимум 3-5шт.
- Расходники: запасные пропеллеры того же диаметра с тем же типом крепления и диаметром отверстия под вал, ремешки для аккумуляторов.
- [Инструмент по типу шестигранников, ключей для гаек моторов](/ru/shop/nessesary)

## Комфортный вход (800-1500$)

Поздравляю, у вас есть возможность выбрать видеосистему на свой вкус!

- [Примеры аппаратур. Не забудьте аккумуляторы!](/ru/intro/tx)
- [Очки с видеосистемой под ваши задачи](/ru/intro/vrx)
- [Дрон под желаемый стиль полета с приемником того же радиолинка, что и в аппаратуре](/ru/intro/flightstyles)
- [Зарядное устройство + (при необходимости) блок питания (БП)](/ru/intro/power#как-выбрать-зарядное-устроиство)
