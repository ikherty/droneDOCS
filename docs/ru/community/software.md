...
Все необходимые драйвера можно скачать здесь: [архивы в облаке](https://clck.ru/35Xp2W). 

Скорее всего вам пригодится только файл [DFU драйвера](https://clck.ru/3EmPiT). Причина проблемы в том, что Windows считает, что лучше разбирается в драйверах для устройств и при обновлениях заменяет рабочий драйвер от stm на свой нерабочий, поэтому процедуру придется периодически повторять. 

Важно: полетники на AT32 контроллере имеют свой собственный [DFU драйвер](https://drive.google.com/drive/folders/1N9b9aRWggz9G2T83CFeXRQgvVgxlf5Y3?usp=drive_link).

Также ссылки на скачивание находятся на главной странице бетафлайт конфигуратора в желтой зоне, но на всякий случай продублированы здесь:

Zadig (для обновления USB драйверов, чаще всего нужен при проблемах в режиме бутлоадера(загрузчика)):  
https://zadig.akeo.ie

ImpulseRC driver fixer устанавливает DFU дайвер автоматически (для кого-то этот способ может показаться проще, чем напрямую установить DFU драйвер по ссылке в начале раздела):
