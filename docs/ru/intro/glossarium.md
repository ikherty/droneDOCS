...
| TVL                                   | число телевизионных линий - характеристика аналоговых камер, обозначает разрешение камеры |
...
| маунт                                 | крепеж чего-либо, обычно камеры, антенны и т.д. |
| tx                                    | передатчик, передает сигнал (может быть как отдельным устройством так и передающим пином на плате) |
| rx                                    | приемник, принимает сигнал (может быть как отдельным устройством так и передающим пином на плате)|
