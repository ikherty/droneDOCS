...
> If any terms are unclear, check this [glossary](/intro/glossarium).
...
Famous freestylers and tutorials can be found [in the Useful Materials section](/community/usefull).
